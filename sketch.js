...
function setup() {
  ...
  //level three
  block13 = new turquoiseBlock(360,195,30,40);
  block14 = new turquoiseBlock(390,195,30,40);
  block15 = new turquoiseBlock(420,195,30,40);
  //top
  block16 = new whiteBlock(390,155,30,40);

  //level 1
  block17 = new pinkBlock(640,150,30,40);
  block18 = new pinkBlock(670,150,30,40);
  block19 = new pinkBlock(700,150,30,40);
  block20 = new pinkBlock(730,150,30,40);
  block21 = new pinkBlock(760,150,30,40);
  //level 2
  block22 = new Block(670,110,30,40);
  block23 = new Block(700,110,30,40);
  block24 = new Block(730,110,30,40);
  //top
  block25 = new turquoiseBlock(700,70,30,40);
...
function draw() {
  ...
  fill("white");
  textSize(17);
  text("Press space to get a second chance to play", 250,30);
